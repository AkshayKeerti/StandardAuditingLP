            ...
            <div className="bg-gradient-to-r from-vigor-green/10 to-vigor-blue/10 backdrop-blur-sm rounded-3xl p-8 lg:p-12 border border-white/20">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
                <div className="text-center">
                  ...
                  <h4 className="text-lg font-bold text-white mb-2">Certified UAE Tax Agents</h4>
                  <p className="text-gray-300 text-sm">Officially recognized by the Federal Tax Authority</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-lg font-bold text-white mb-2">10+ Years Serving UAE Businesses</h4>
                  <p className="text-gray-300 text-sm">Decade of experience in UAE tax landscape</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-lg font-bold text-white mb-2">Recognized by Major Industry Associations</h4>
                  <p className="text-gray-300 text-sm">Member of leading professional bodies</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-lg font-bold text-white mb-2">4.9 Star Google Rating</h4>
                  <p className="text-gray-300 text-sm">Consistently high client satisfaction</p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <h4 className="text-lg font-bold text-white mb-2">Proactive Updates on FTA Changes</h4>
                  <p className="text-gray-300 text-sm">Stay ahead of regulatory developments</p>
                </div>
              </div>
            </div>
          </div>
