      ...
      <div className="container-custom py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="space-y-3 sm:space-y-4">
            <h3 className="text-base sm:text-lg font-semibold">Head Office</h3>
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xs sm:text-sm text-gray-600 text-left">04 379 5200</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xs sm:text-sm text-gray-600 text-left">info@standardauditors.com</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-2">
              {quickLinks.map((link, index) => (
                <a
                  ...
                  className="block text-xs sm:text-sm text-gray-600 hover:text-gray-800 transition-colors text-left"
                >
                  {link}
                </a>
              ))}
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="w-full h-32 sm:h-48 bg-gray-200 rounded-lg flex items-center justify-center">
              <span className="text-gray-600 text-xs sm:text-sm text-center px-4">
