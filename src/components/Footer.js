        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-2 sm:space-y-3">
              <div className="flex items-center space-x-3">
                <svg className="w-6 h-6 sm:w-4 sm:h-4 md:w-5 md:h-5 text-secondary flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <span className="text-lg sm:text-xs md:text-sm text-gray-600 font-medium">+971 54 211 9784</span>
              </div>
              
              <div className="flex items-center space-x-3">
                <svg className="w-6 h-6 sm:w-4 sm:h-4 md:w-5 md:h-5 text-green-500 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-lg sm:text-xs md:text-sm text-gray-600 font-medium">WhatsApp: +971 54 211 9784</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-lg sm:text-xs md:text-sm text-gray-600 font-medium">Sales@standardauditors.com</span>
              </div>
