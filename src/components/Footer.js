          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xs sm:text-sm text-gray-600">info@standardauditors.com</span>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-2">
              {quickLinks.map((link, index) => (
                <a
                  ...
                  className="block text-xs sm:text-sm text-gray-600 hover:text-gray-800 transition-colors"
                >
                  {link}
                </a>
              ))}
