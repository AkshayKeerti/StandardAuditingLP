      ...
      <div className="container-custom py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-12">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div>
              <h3 className="text-lg sm:text-xl font-bold text-vigor-blue mb-2">Standard Auditing</h3>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-2 sm:space-y-3">
              <div className="flex items-center space-x-3">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-vigor-green flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                </svg>
                <span className="text-xs sm:text-sm text-gray-600">+971 50 382 1750</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xs sm:text-sm text-gray-600">WhatsApp: +971 50 382 1750</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xs sm:text-sm text-gray-600">info@standardauditing.ae</span>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-xs sm:text-sm text-gray-600">04 379 5200</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-2 sm:space-y-3">
              <div className="flex items-start space-x-3">
                <svg className="w-4 h-4 sm:w-5 sm:h-5 text-vigor-green mt-1 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-2">
              {quickLinks.map((link, index) => (
                <a
                  ...
                  className="block text-xs sm:text-sm text-gray-600 hover:text-vigor-blue transition-colors"
                >
                  {link}
                </a>
              ))}
            ...
            <div className="pt-4">
              ...
              <div className="flex space-x-3">
                <a href="#" className="text-gray-400 hover:text-vigor-blue transition-colors">
