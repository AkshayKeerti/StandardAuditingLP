          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="pt-4">
              ...
              <div className="flex space-x-3">
                <a href="https://instagram.com/standardauditing" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors">
                ...
                <a href="https://standardauditing.ae" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
